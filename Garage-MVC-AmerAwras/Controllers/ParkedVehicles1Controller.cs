...
namespace Garage_MVC_AmerAwras.Controllers
{
    public class ParkedVehicles1Controller : Controller
    {
        ...
        public ActionResult Index(int? MemberId)
        {
            ...
            var parkedV = db.Vehicles.Include(p => p.Members);

            if (MemberId.HasValue)
            {
                parkedV = parkedV.Where(p => p.MemberId == MemberId);
            }

            ViewBag.MemberId = MemberId;
            return View(parkedV.ToList());
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,RegNumber,Color,Brand,Model,NumberOfWheels,CheckIn,VehicleType,MemberId")] ParkedVehicle parkedVehicle)
        {
            if (ModelState.IsValid)
            {
